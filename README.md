...
[![JS Coverage](https://img.shields.io/codecov/c/github/allenyllee/CursorCine?flag=unittests&label=JS%20Coverage)](https://codecov.io/gh/allenyllee/CursorCine?flags%5B0%5D=unittests)
[![Native Coverage](https://img.shields.io/codecov/c/github/allenyllee/CursorCine?flag=native-windows&label=Native%20Coverage)](https://codecov.io/gh/allenyllee/CursorCine?flags%5B0%5D=native-windows)
...
- 畫筆互動模式可切換：`穩定優先`（降低誤觸）/ `流暢優先`（更順的滾輪與切換手感）
- HDR 多螢幕高風險情境（包含錄影中首次在目標螢幕啟動畫筆）下，畫筆會自動降級為「非攔截」以避免黑屏，並在狀態列與畫筆按鈕顯示提示
