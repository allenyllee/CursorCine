...
function createPreloadApi(ipcRenderer) {
  ...
  return {
    ...
    hdrPreviewEncodedStart: (payload) => ipcRenderer.invoke('hdr:preview-encoded-start', payload),
    hdrPreviewEncodedRead: (payload) => ipcRenderer.invoke('hdr:preview-encoded-read', payload),
    hdrPreviewEncodedStop: (payload) => ipcRenderer.invoke('hdr:preview-encoded-stop', payload),
